    ...
    translations: {
      en: {
        ...
        solution: {
          title: 'Solution',
          content: [
            'Designed and developed a visually engaging homepage and yacht gallery, enabling users to explore each yacht in detail, view specifications, and assess its condition.',
            'Implemented a custom CRM system for effortless yacht management and a secure, user-friendly payment system to streamline purchases.',
      ...
      uk: {
        ...
        solution: {
          title: 'Рішення',
          content: [
            'Було розроблено візуально привабливу головну сторінку та галерею яхт, яка дозволяє користувачам детально переглядати кожну яхту, ознайомлюватися з характеристиками та оцінювати її стан.',
            'Реалізовано власну CRM-систему для зручного керування яхтами та безпечну, інтуїтивну платіжну систему.',
